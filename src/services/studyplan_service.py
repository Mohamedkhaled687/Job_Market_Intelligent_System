...
# i didn't edit this method (mostafa-al-hassan)
# i commented it out
...
class StudyPlanService:
    def __init__(self, db):
        self.curriculum_fetcher = CurriculumFetcher(db)
    
    async def generate_study_plan(self, user_query: str):
        
        result = await self.curriculum_fetcher.sync()
        
        lessons = await self.curriculum_fetcher.get_lessons_for_vector_embedding()
